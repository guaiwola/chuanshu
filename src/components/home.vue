    ...
    <div class="part1">
      <div class="introduction">
        <div class="introduction-text">
          ...
          <br>
          <p>
            青柚工作室成立于 2013 年 10 月，多年来不断的整合市场上博彩游戏，为游戏供货商整合标准接口的同时，更为您站点上的玩家提供更多产品选择；
            “青柚工作室是真正能站在您与玩家的角度考虑的平台商，想您所想、急您所急,如果您希望在产品上面有何特色，请及时告知我们！ AG接口申请 BBIN接口申请。
          </p>
          <p>出于对技术的热爱和对设计的追求，青柚工作室对产品需求,团队全天候不断探索市场发展方向；智能优惠活动、DIY竞猜活动、均为行业首创；</p>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    navToOauth() {
      window.location.href = `https://wpa.qq.com/msgrd?v=3&uin=532222521&site=qq&menu=yes`;
    }
  }
};
</script>
